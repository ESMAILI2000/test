...
fun UnitsListScreen(
    ...
    var MainStatus by remember { mutableStateOf(2) } // 1:home 2:users 3:reports 4:contacts 5:coast
        ...
        Box(modifier.fillMaxSize()) {
            ...
            Box (
                ...
                Icon(
                    ...
                    contentDescription = "Export Units",
                    Modifier
                        .padding(10.dp)
                        .fillMaxSize(1f),
                    tint = Blue500// برای کاربر سطح 1 آبی برای بقیه سزوح خاکستری
                )
            }
            Row(
                Modifier
                ...
                repeat(20) { index ->
                    Box(
                        ...
                        Column (
                            ...
                            Text(
                                "محمد مهدی مرادی", // مسئول واحد
                                Modifier.padding(start = 0.dp, top = 0.dp),
                                color = Gray400,
                                fontSize = 17.sp,
                                fontFamily = FontFamily(Font(R.font.roboto)),
