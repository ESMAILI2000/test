...
fun CoastsListScreen(
    ...
    var MainStatus by remember { mutableStateOf(5) } // 1:home 2:users 3:reports 4:contacts 5:coast
            ...
            Column(
                ...
                repeat(20) { index ->
                    Box(
                        ...
                        Text(
                            "345000", // مبلغ هزینه سبز یا قرمز به زیال
                            Modifier
                                .padding(top = 10.dp)
                                .align(Alignment.TopStart),
                            color = Gray600,
