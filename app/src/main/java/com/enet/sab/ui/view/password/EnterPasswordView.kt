                ...
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        keyboardActions = KeyboardActions(
                            onGo = {
                                var i= login(passwordIn ,context)
                                if (i==1){
                                    onHomeClicked()
                                }else if (i == 2){
                                    onChengPasswordClicked()
                                }
                            }
                        ),
                        singleLine = true,
                    ...
                    Button(
                        ...
                        Text(text = "ورود", textAlign = TextAlign.Center, fontSize = 29.sp, fontWeight = FontWeight(500))
                    }
...
fun login(passwordIn: String ,context: Context): Int {
    ...
    if (passwordIn.length < 4) {
        ...
        return 0
    }else if((profile?.password ?: "1111") == "1111") {
    return 2
    }else {
        return 1
    }
